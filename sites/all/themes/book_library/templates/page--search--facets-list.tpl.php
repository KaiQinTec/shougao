...
<style type="text/css">
    ...
    .facets-line > div.views-field-field-qwtp {
        width: 128px;
        height: 173px;
        border: 1px solid #ccc;
        padding: 3px;
    ...
    .facets-line > div.views-field-field-qwtp img {
        width: 100%;
        height: 100%;
    }
    .views-field {
    ...
    .facets-line div.views-field-title a {
        font-size: 18px;
        color: #0074BD;
    }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalShowNodeTypesLabel">详情界面</h4>
            </div>
