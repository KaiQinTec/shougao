...
<div class="main-container" id="main-container">
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="row">
                <?php if($current_path == 'search/gaoji'): ?>
                    <div class="left-bar col-md-3">
                        <?php print render($page['leftbar']);?>
                    </div>
                <?php endif;?>
                <div class="<?php if($current_path == 'search/gaoji') { print "col-md-9"; } else { print 'page-content'; } ?>">
...
<!-- BEGIN　选择著录类型 Modal -->
<div class="modal fade bs-example-modal-sm" id="modalContentTypes" tabindex="-1" role="dialog"
     aria-labelledby="modalContentTypesLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalContentTypesLabel">选择著录类型</h4>
            </div>
            <div class="modal-body ">
                <select name="select-type" id="select-type" size="<?php print count($content_types);?>">
                    <?php foreach($content_types as $type => $type_title) :?>
                        <option value="<?php print $type;?>"><?php print $type_title;?></option>
                    <?php endforeach;?>
                </select>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn grey-mint" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary select-type">选择</button>
            </div>
        </div>
    </div>
</div>
<!-- END　选择著录类型 Modal -->
<!-- BEGIN　展示规范档 Modal -->
<div class="modal fade" id="modalAPIList" tabindex="-1" role="dialog"
     aria-labelledby="modalAPIListLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalAPIListLabel">选择规范档</h4>
            </div>
            <div class="modal-body ">
                <form class="form-inline row">
                    <div class="form-group col-md-8">
                        <label class="sr-only" for="searchKeyWord">输入关键字</label>
                        <input type="email" class="form-control" id="searchKeyWord" placeholder="作者姓名">
                    </div>
                    <button type="button" class="btn btn-default" id="searchAPIList">查询</button>
                    <button type="button" class="btn btn-default" id="modalSearcheAddUser">添加</button>
                    <input type="hidden" name="current_input_index" id="current_input_index" value="0"/>
                </form>
                <table class="table table-striped" id="specAuthorList">
                    <thead>
                        <tr>
                            <th>姓名</th>
                            <th>地区</th>
...
<!-- END　展示规范档 Modal -->
<!-- BEGIN　展示地址规范档 Modal -->
<div class="modal fade" id="modalAddressAPIList" tabindex="-1" role="dialog"
     aria-labelledby="modalAddressAPIListLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title" id="modalAddressAPIListLabel">选择规范档</h4>
            </div>
            <div class="modal-body ">
                <form class="form-inline row">
                    <div class="form-group col-md-8">
                        <label class="sr-only" for="searchKeyWord">输入关键字</label>
                        <input type="email" class="form-control" id="searchAddressKeyWord" placeholder="地址">
                    </div>
                    <button type="button" class="btn btn-default" id="searchAddressAPIList">查询</button>
                    <button type="button" class="btn btn-default" id="modalSearcheAddAddr">添加</button>
                    <input type="hidden" name="current_address_input_index" id="current_address_input_index" value="0"/>
                </form>
                <table class="table table-striped" id="specAddressList">
                    <thead>
                        <tr>
                            <th>国家</th>
                            <th>省/市</th>
...
<!-- END　展示节点内容 Modal -->
<!-- BEGIN　添加人名规范档 Modal -->
<div class="modal fade" id="modalAPIAdd" tabindex="-1" role="dialog"
     aria-labelledby="modalAPIAddLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title" id="modalAPIAddLabel">写入规范档</h4>
            </div>
            <div class="modal-body ">
                <form class="form-horizontal" id="addUserForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="chsName" id="chsName" placeholder="中文名">
                        </div>
                        <div class="col-sm-1 need-input-star">*</div>
                    </div>
                    <div class="form-group">
                        <label for="birthDay" class="col-sm-2 control-label">出生年月</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="birthday" id="birthday" placeholder="出生年月">
                        </div>
                        <div class="col-sm-1 need-input-star">*</div>
                    </div>
                    <div class="form-group">
                        <label for="deathDay" class="col-sm-2 control-label">死亡年月</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="deathday" id="deathday" placeholder="死亡年月">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="addSearchAPIList" class="col-sm-2 control-label">籍贯</label>
                        <div class="col-sm-9 input-group">
                            <input type="text" class="form-control" name="userAddAddress" id="userAddAddress" placeholder="籍贯">
                            <div class="input-group-addon" id="searchUserAddressList">查询</div>
                            <!--div class="input-group-addon" id="clearUserAddAddress">清空</div-->
                            <input type="hidden" id="nativePlace" name="nativePlace" placeholder="籍贯" />
                        </div>
                        <div class="col-sm-1 need-input-star">*</div>
                    </div>
                    <input type="hidden" name="current_add_user_input_index" id="current_add_user_input_index" value="0"/>
                </form>
                <table class="table table-striped" id="addUserAddressList">
                    <thead>
                        <tr>
                            <th>国家</th>
                            <th>省/市</th>
            ...
            <div class="modal-footer">
            <button type="button" class="btn btn-default pull-right" id="userSearchAPIAdd">添加</button>
            </div>
        </div>
    </div>
</div>
<!-- END　添加人名规范档 Modal -->
<!-- BEGIN　添加地名规范档 Modal -->
<div class="modal fade" id="modalAddrAdd" tabindex="-1" role="dialog"
     aria-labelledby="modalAddrAddLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title" id="modalAddrAddLabel">写入规范档</h4>
            </div>
            <div class="modal-body ">
                <form class="form-horizontal" id="addAddrForm">
                    <div class="form-group">
                        <label for="label" class="col-sm-2 control-label">名称</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="label" id="label" placeholder="名称">
                        </div>
                        <div class="col-sm-1 need-input-star">*</div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="province" id="province" placeholder="省">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="city" class="col-sm-2 control-label">市</label>
                        <div class="col-sm-9 input-group">
                            <input type="text" class="form-control" name="city" id="city" placeholder="市">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="hidden" name="current_add_address_input_index" id="current_add_address_input_index" value="0"/>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id="addressAPIAdd">添加</button>
                <button type="button" class="btn grey-mint" data-dismiss="modal">关闭</button>
            </div>
        </div>
    </div>
